...
interface NodeGraphProps extends React.HTMLAttributes<HTMLDivElement> {
  labels?: string[];
  density?: number;
}
...
export function NodeGraph({
  ...
  React.useEffect(() => {
    // Rebind after the guard with explicit non-null types: TS narrowing
    // does not flow into the hoisted closures below (build/onMove/...).
    ...
    const onMove = (e: MouseEvent) => { const r = wrap.getBoundingClientRect(); mouse.x = e.clientX - r.left; mouse.y = e.clientY - r.top; };
